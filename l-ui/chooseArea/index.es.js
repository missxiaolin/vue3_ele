import { defineComponent, ref, watch, resolveComponent, openBlock, createElementBlock, createVNode, unref, isRef, withCtx, Fragment, renderList, createBlock, createTextVNode, toDisplayString } from "vue";
var allArea = [
  {
    code: "11",
    name: "\u5317\u4EAC\u5E02",
...
var index = {
  install(app) {
    app.component("l-choose-area", _sfc_main);
  }
};
