...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: emits }) {
    ...
    return (_ctx, _cache) => {
      const _component_l_form = resolveComponent("l-form");
      const _component_el_dialog = resolveComponent("el-dialog");
      return openBlock(), createElementBlock("div", {
        class: normalizeClass({ "l-choose-icon-dialog-body-height": __props.isScroll })
      }, [
...
var index = {
  install(app) {
    app.component("l-modal-form", _sfc_main);
  }
};
